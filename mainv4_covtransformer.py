...
def main(config_file):
    ...
    transformer = CovTransformer(x_iv_train, x_cov_train, target_train, x_iv_val, x_cov_val, target_val, config_file)
    transformer.compile()
    ...
    pred_val = transformer.pred(x_iv_val, x_cov_val)
    pred_test = transformer.pred(x_iv_test, x_cov_test)
